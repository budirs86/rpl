              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="action/simpan.php" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Tempat Lahir" name="tempat_lahir">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" rows="4" name="alamat"></textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Nomor Telepon</label>
                        <input type="number" class="form-control" id="exampleInputName1" placeholder="Nomor Telepon" name="nomor_telepon">
                      </div>

                      <button type="submit" class="btn btn-primary me-2">Simpan</button>
                      <a href="tbl_pendaftaran.php" class="btn btn-light">Batal</a
                    </form>
                  </div>
                </div>
              </div>
